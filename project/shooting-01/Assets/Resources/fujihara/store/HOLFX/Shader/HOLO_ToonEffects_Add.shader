...
////// Emissive:
                ...
                float3 emissive = (_Value*(node_7218*i.vertexColor.a*lerp( (i.vertexColor.rgb+(_LightValue*smoothstep( _VolMin, 1.0, node_7218 ))+float3(i.uv2.r,i.uv2.g,i.uv2.b)), ((1.0 - node_7218)*i.vertexColor.rgb), _Dark_or_Light )));
